...
public class Zoo {
    ...
    public Zoo() {
        animals = new ArrayList<>(Arrays.asList(new Fish("Willy","killerwhale", "white-black", 5,56),new Cat("barsik","vislauh", "black", 4,6)
        ,new Dog("sedi","ratvailer", "brown", 4,2), new Duck("kru","rat", "white", 2,1),new Fish("Jhonny","carp", "yellow", 2,12), 
        new Turtle("Om","little", "rainbow", 4,100,12)));
